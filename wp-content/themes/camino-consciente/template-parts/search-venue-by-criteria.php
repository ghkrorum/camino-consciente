...
<div id="wrapper" class="wrapper-interior">
    <div id="filtros-curso" class="section filtro-centro">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="row header row-search-form <?= (!is_page())?'row-search-form-desktop':''; ?>">
                        <div class="col-md-12 filter">
                            <div class="row white-gradient">
                                    <div class="col-md-12">
                                        <h1>Busca el centro de enseñanza <br>perfecto para tí</h1>
                ...
                <div class="col-md-9 articles-container">
                    ...
                    wp_reset_postdata();
                    ?>
                    <?php echo do_shortcode('[ajax_load_more repeater="template_9" tag="'.$searchTag.'" post_type="centros_de_ensenanza" taxonomy="'. implode(':', $almTaxonomy) .'" taxonomy_terms="'. implode(':', $almTerms) .'" post__not_in="' . implode(",", $exclude_post_ids ) . '" button_label = "Ver más" button_loading_label="Cargando más centros de enseñanza" ]'); ?>
                </div>
